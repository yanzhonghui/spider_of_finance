...
try:
    driver.get('http://www.pbc.gov.cn/zhengcehuobisi/125207/125213/125440/3876551/index.html')
...
#     driver.get('http://www.pbc.gov.cn/zhengcehuobisi/125207/125213/125431/125475/17081/index' + str(p) + '.html')
#     table_tag = \
#         driver.find_element_by_id("r_con").find_element_by_tag_name('tbody').find_elements_by_tag_name('tr')[
#             1].find_element_by_tag_name('td').find_elements_by_tag_name('table')
#     for t in table_tag:
